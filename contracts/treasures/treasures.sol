...
/*
 * Atlantis Treasures contract, forked from xGrail Dividends contract
 *
...
contract DividendsV2 is Ownable, ReentrancyGuard, IDividendsV2 {
    ...
    IERC20 public immutable xGrailToken; // xGrailToken contract
    ...
    constructor(address xGrailToken_, uint256 startTime_) {
        ...
        xGrailToken = IERC20(xGrailToken_);

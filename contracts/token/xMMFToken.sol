 ...
 */
contract xMMFToken is ERC20, Ownable {
    ...
    function _mint(address account, uint256 amount) internal virtual override {
        require(
            ...
            "xMMF: mint amount exceeds max supply"
        );
    ...
    function burnFrom(address account, uint256 amount) external onlyMinter {
        ...
        require(
            ...
            "xMMF: burn amount exceeds allowance"
        );
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(
            ...
            "xMMF: _addMinter is the zero address"
        );
    ...
    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(
            ...
            "xMMF: _delMinter is the zero address"
        );
